...
<div class="box-header with-border">
               ...
               <div class="col-sm-4"> 
                    <input type='text' id='email_title' class="form-control" placeholder="Template Name" name="email_title" value="{{isset($data['keywords']['email_title'])?$data['keywords']['email_title']:''}}" />
                    ...
                    <div class="col-sm-3"> 
					 ...
					 <a class="btn btn-default btn-flat" href="{{ url('/admin/email_list') }}"><span class="fa fa-refresh fa-fw"></span> Reset</a>
                  </div>
                ...
                <div class="row">
                  ...
                  <!--<a href="{{ url('/admin/email') }}" class="btn-dark btn"> <span class="fa fa-plus fa-fw"></span> Add Email</a>-->
