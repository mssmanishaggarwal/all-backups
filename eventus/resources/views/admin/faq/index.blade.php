...
<div class="box-header with-border">
               ...
               <div class="col-sm-4"> 
                    <input type='text' id='faq_title' class="form-control" placeholder="FAQ Title" name="faq_title" value="{{isset($data['keywords']['faq_title'])?$data['keywords']['faq_title']:''}}" />
                    ...
                    <div class="col-sm-3"> 
					 ...
					 <a class="btn btn-default btn-flat" href="{{ url('/admin/faq_list') }}"><span class="fa fa-refresh fa-fw"></span> Reset</a>
                  </div>
                ...
                <div class="row">
                  ...
                  <a href="{{ url('/admin/faq') }}" class="btn-dark btn"> <span class="fa fa-plus fa-fw"></span> Add FAQ</a>
        ...
        <div class="box box-default" id="recordset">			   
                <div class="box-body no-padding">
                    <table class="table table-striped table-hover">
						<tr class="warning">                                
							<th width="70%">
							<a href="javascript:;" onclick="ordering('ordering','{{$data['orderby']}}','atrans.faq_title')">FAQ TITLE <i id="faq_title" class="fa fa-sort-alpha-{{$data['fa_order']}} text-muted"></i> </a></th>                       	<th width="15%" class="text-center">ORDER</th>
                            <th width="15%" class="text-right">ACTIONS</th>
                        </tr>
						@foreach($data['dataGrid'] as $dataset)
						<tr>
							<td>{{$dataset->faq_title}}
							...
							<button type="button" class="btn btn-default" onclick="document.location.href='{{ url('/admin/faq') }}/{{$dataset->id}}'" title="Update"> <span class="fa fa-edit text-warning"></span></button>
