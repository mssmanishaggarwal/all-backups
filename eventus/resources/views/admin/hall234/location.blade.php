...
<form id="master-file-form" novalidate="novalidate" class="form-horizontal">
 ...
 <ul class="nav nav-tabs custom-tab" role="tablist">
    ...
    <li role="presentation" class="active"><a href="{{url('/admin/hall/set-location')}}/{{$page_id}}" class="disable_link"><span class="fa fa-map"></span> Set Location</a></li>
...
{{ Html::script('public/js/add_hall_location.js') }}
@endsection
