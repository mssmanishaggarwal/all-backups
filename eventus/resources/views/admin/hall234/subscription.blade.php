...
?>
 ...
 <ul class="nav nav-tabs custom-tab" role="tablist">
    ...
    <li role="presentation" ><a href="{{url('/admin/hall/addon/')}}/{{$page_id}}" aria-controls="messages" role="tab" data-toggle="tab"><span class="fa fa-puzzle-piece fa-fw"></span> Addon Services</a></li>
    <li role="presentation" ><a href="{{url('/admin/hall/accommodation/')}}/{{$page_id}}" ><span class="fa fa-bed fa-fw"></span> Accommodation</a></li>
     <li role="presentation" class="active"><a href="{{url('/admin/hall/subscription/')}}/{{$page_id}}" ><span class="fa fa-cube"></span> Subscription</a></li>
  </ul>
                 ...
                 <div class="box box-warning">
                   <div class="tab-content" data-page="{{$page_id}}">
                    ...
                    <div class="box-header with-border">
                                      <h3 class="box-title"> Subscription
                                    </h3>
...
{{ Html::script('public/js/add_hall_subscription.js') }}
@endsection