...
<div class="box-header with-border">
               ...
               <div class="col-sm-4"> 
                    <input type='text' id='hall_type_name' class="form-control" placeholder="Hall Type Name" name="hall_type_name" value="{{isset($data['keywords']['hall_type_name'])?$data['keywords']['hall_type_name']:''}}" />
                    ...
                    <div class="col-sm-4"> 
					 ...
					 <a class="btn btn-default btn-flat" href="{{ url('/admin/halltype_list') }}"><span class="fa fa-refresh fa-fw"></span> Reset</a>
                  </div>
                ...
                <div class="row">
                  ...
                  <a href="{{ url('/admin/halltype') }}" class="btn-dark btn"> <span class="fa fa-plus fa-fw"></span> Add Hall Type</a>
        ...
        <div class="box box-default" id="recordset">			   
                <div class="box-body no-padding">
                    <table class="table table-striped table-hover">
						<tr class="warning">                                
							<th width="70%">
							<a href="javascript:;" onclick="ordering('ordering','{{$data['orderby']}}','atrans.hall_type_name')">HALL TYPE NAME <i id="hall_type_name" class="fa fa-sort-alpha-{{$data['fa_order']}} text-muted"></i> </a></th>                       	<th width="15%" class="text-center">ORDER</th>
  ...
  <button type="button" class="btn btn-default" title="Delete" onclick="deletedata('delete',{{$dataset->hall_type_id}})" ><span class="fa fa-trash text-danger"></span></button></div></td>
						...
						<tr>
							...
							{{ Html::image('public/images/admin/alert.png','Alert') }}
							<br/>No Record Found.
							</td>
						</tr>
						@endif
