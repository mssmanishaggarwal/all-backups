...
<div class="box-header with-border">
               ...
               <div class="col-sm-4"> 
                    <input type='text' id='banner_title' class="form-control" placeholder="Home Page Banner" name="banner_title" value="{{isset($data['keywords']['banner_title'])?$data['keywords']['banner_title']:''}}" />
                    ...
                    <div class="col-sm-3"> 
					 ...
					 <a class="btn btn-default btn-flat" href="{{ url('/admin/homepagebanner_list') }}"><span class="fa fa-refresh fa-fw"></span> Reset</a>
                  </div>
                ...
                <div class="row">
                  ...
                  <a href="{{ url('/admin/homepagebanner') }}" class="btn-dark btn"> <span class="fa fa-plus fa-fw"></span> Add Home Page Banner</a>
