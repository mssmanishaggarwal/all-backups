...
<div class="box-header with-border">
               ...
               <div class="col-sm-4"> 
                    <input type='text' id='testimonial_name' class="form-control" placeholder="Testimonial" name="testimonial_name" value="{{isset($data['keywords']['testimonial_name'])?$data['keywords']['testimonial_name']:''}}" />
                    ...
                    <div class="col-sm-4"> 
					 ...
					 <a class="btn btn-default btn-flat" href="{{ url('/admin/testimonial_list') }}"><span class="fa fa-refresh fa-fw"></span> Reset</a>
                  </div>
                ...
                <div class="row">
                  ...
                  <a href="{{ url('/admin/testimonial') }}" class="btn-dark btn"> <span class="fa fa-plus fa-fw"></span> Add Testimonial</a>
