                     ...
                     <td width="100%">
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              ...
                              <!-- Spacing -->
                              <tr>
                                 <td bgcolor="#ffffff" style="border-bottom:2px solid #f36d21;">
                                    <!-- logo -->
                                          ...
                                          <tr>
                                             <td width="140" height="60" align="center">
                                                <div class="imgpop">
                                                   ...
                                                   <img src="<?php echo url('/'); ?>/public/images/site/email_logo.png" height="42" width="120" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
         ...
         <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td width="100%">
                        <table width="600" bgcolor="#f36d21" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              <!-- Spacing -->
                              <tr>
                                 <td width="100%" height="10"></td>
                                 ...
                                 <td style="padding:0px 5px;">
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" >
                                       <tbody>
                                          ...
                                          <!-- Title -->
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 20px;font-weight:bold; color: #000000; text-align:left; line-height: 24px;">
                                    <!-- Mail body start -->   
	                                        <table border="0" width="100%" cellspacing="0" cellpadding="0">
											<tbody>
											<tr>
											<td><strong style="font-family: Helvetica, arial, sans-serif; font-size: 15px; font-weight: bold; color: #000000; line-height: 24px;">Dear {{$user->first_name}},</strong></td>
											</tr>
											<tr>
											<td height="10">&nbsp;</td>
											</tr>
											<tr>
											<td>
											<p style="font-family: Helvetica, arial, sans-serif; font-size: 12px; color: #222; line-height: 24px;">Click here to reset your password: {{ url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}</p>
											</td>
											</tr>
                     ...
                     <td width="100%">
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" >
                           <tbody>
                              ...
                              <tr>
                                 <td>
                                    <table width="600" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth" style="border-top:5px solid #f36d21; background:#fff;">
                                       <tbody>
                                        <!-- Spacing -->
                                      <tr>
                                         <td width="100%" height="10"></td>
                                     ...
                                     <!-- Spacing -->
                                          <tr>
                                             <td align="center" valign="middle"> 
                                                <p style="font-family: Helvetica, arial, sans-serif; font-size: 12px;color: #333" st-content="viewonline"> &copy; 2016 Eventus Angola All rights reserved.</p>
                                             </td>
                                          </tr>
                                           <tr>
                                         <td width="100%" height="10"></td>
