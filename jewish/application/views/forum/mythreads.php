 ...
 $(document).ready(function(){
   ...
   $('.'+comre).toggle('slow');
	...
	$('.mydata').click(function(e){
		...
		var r = confirm("Do you really want to delete a thread!");
...
-->       <h4><a href="<?php echo JEWISH_URL;?>/forum/<?php echo strtolower($ky); ?>/<?php echo $commentforumdata[$i]['forum_slug'] ; ?>"><?php echo $commentforumdata[$i]['forum_name'] ; ?></a><br><span><?php echo strtolower($ky); ?></span></h4>
       ...
       <h5>
         ...
         <img id="<?php echo $commentforumdata[$i]['forum_id'] ?>" class="mydata" style="float:right; margin-top:8px;" src="<?php echo JEWISH_URL;?>/images/cross.png" />

       <span><?php  echo $commentforumdata[$i]['forumcomment_count'] ;?></span><?php  echo $commentforumdata[$i]['forum_modified_date'] ;?>
